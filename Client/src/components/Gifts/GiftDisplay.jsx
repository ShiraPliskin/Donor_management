    ...
    return (
        <>
            ...
            >
                <TableCell sx={{ textAlign: 'center' }}>{gift.id}</TableCell>
                <TableCell sx={{ textAlign: 'center' }}>{gift.description}</TableCell>
                <TableCell sx={{ textAlign: 'center', display: { xs: 'none', sm: 'table-cell' } }}>{gift.gift_cost}</TableCell>
                <TableCell sx={{ textAlign: 'center', display: { xs: 'none', sm: 'table-cell' } }}>{gift.amount}</TableCell>
                <TableCell sx={{ textAlign: 'center' }}>
                    <IconButton onClick={handleClickOpen}>
                        <VisibilityIcon />
                    </IconButton>
