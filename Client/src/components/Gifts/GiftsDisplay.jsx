                ...
                <Box sx={{ minWidth: { xs: '100%', sm: 650 }, maxWidth: 'xl' }}>
                    ...
                    <TableContainer component={Paper} sx={{ marginTop: 5, width: '100%' }}>
                        <Table sx={{ minWidth: { xs: '100%', sm: 850 } }} size='small'>
                            <TableHead>
                                <TableRow>
                                    <TableCell sx={{ fontWeight: 'bold', textAlign: 'center' }}>מס' מתנה</TableCell>
                                    <TableCell sx={{ fontWeight: 'bold', textAlign: 'center' }}>תיאור המתנה</TableCell>
                                    <TableCell sx={{ fontWeight: 'bold', textAlign: 'center', display: { xs: 'none', sm: 'table-cell' } }}>עלות המתנה</TableCell>
                                    <TableCell sx={{ fontWeight: 'bold', textAlign: 'center', display: { xs: 'none', sm: 'table-cell' } }}>כמות במלאי</TableCell>
                                    <TableCell></TableCell>
                                </TableRow>
                            </TableHead>
                            <TableBody>
                        ...
                        {giftsToDisplay.length >= rowsPerPage &&
                            ...
                            <div style={{ textAlign: 'center'}}><p>{`${page * rowsPerPage + 1}-${(page + 1) * rowsPerPage <= totalGiftsCount ? (page + 1) * rowsPerPage : totalGiftsCount} מתוך ${totalGiftsCount}`}</p></div>
                    </TableContainer>
                </Box>
            )}
            <p>{commentArea}</p>
