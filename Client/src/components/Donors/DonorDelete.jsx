...
const DonorDelete = ({ id, warningOpen, setWarningOpen }) => {
    ...
    return (
        <>
            <Dialog
                ...
                maxWidth="lg"
            >
                <DialogTitle> האם אתה בטוח שברצונך למחוק את תורם מספר {id}?</DialogTitle>
                <DialogContent>
                    <Typography variant="h6" gutterBottom>
                        ידוע לי שמחיקת התורם לא ניתנת לשחזור
                    ...
                    <Typography variant="h6" gutterBottom>
                        ידוע לי שמחיקת התורם תגרום למחיקת כל התרומות שלו
                        <IconButton onClick={handleClickDelete}>
                            <Checkbox
                                checked={isChecked}
                                checkedIcon={<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="9 11 12 14 22 4"></polyline><path d="M21 12v7a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h11"></path></svg>}
            ...
            {isSucceed === "success" && <GenericMessage message={`תורם מספר ${newID} נמחק בהצלחה`} type="success" />}
